...
function Search({ search, setSearch }) {
  return (
    <div className='absolute top-5 ml-7 bg-white sm:w-64 md:w-80 lg:w-96 rounded-full overflow-hidden border-2 border-gray-300 p-2.5 px-5 pr-8 flex items-center'>
      <div >
